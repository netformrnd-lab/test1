...
const ALIM = {
  ...
  brand() {
    ...
    h += block('건축사가 만든 서비스', '22년간 다양한 건축 현장을 경험하며 알았습니다. 복잡한 공사에는, <b>입주민의 입장에서 판단하고 끝까지 확인해 줄 전문가</b>가 필요하다는 것을.')
    h += block('어렵던 공사를, 쉽고 투명하게', '관리소장도 입주민도 모든 과정을 직접 보긴 어렵습니다. 그래서 현장을 <b>사진과 기록</b>으로 남기고, 누구나 쉽게 이해하도록 <b>투명하게 공유</b>합니다.')
    h += block('만족하는 감리', '우리가 만들고 싶은 건 하자 없는 공사만이 아닙니다. <b>안심하고 결정할 기준, 신뢰할 수 있는 과정, 시간이 지나도 남는 기록</b>입니다.')
    h += block('바른 공사가 당연한 문화로', '공사의 품질은 좋은 자재·기술만으로 결정되지 않습니다. <b>진단하고, 기준대로 확인하고, 기록하는 것</b> — 보이지 않던 과정을 보이게 만듭니다.')
    h += block('감리의 기준', '마지막에 잘됐는지만 보는 감리가 아니라, <b>진단부터 준공·사후까지 잇는 유지보수 전문 파트너.</b> ‘스퀘어’는 <b>기준과 균형</b>을 뜻합니다.')
  ...
  features() {
    ...
    h += [['📋', '감리일지', '감리사가 남긴 기록을 그날 바로', '현황'], ['📸', '현장 사진', '매 공정을 사진으로 투명하게', '현황'], ['📅', '공사 일정', '다가오는 일정을 홈에서 한눈에', '홈'], ['💬', '담당 감리사', '궁금하면 앱 채팅으로 바로', '채팅']]
