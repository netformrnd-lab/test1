...
const ALIM = {
  ...
  brand() {
    ...
    h += block('건축사가 만든 서비스', '22년간 다양한 건축 현장을 경험하며 알았습니다.<br>복잡한 공사에는, <b>입주민의 입장에서 판단하고<br>끝까지 확인해 줄 전문가</b>가 필요하다는 것을.')
    ...
    h += block('바른 공사가 당연한 문화로', '공사의 품질은<br>좋은 자재·기술만으로 결정되지 않습니다.<br><b>진단하고, 기준대로 확인하고, 기록하는 것</b><br>— 보이지 않던 과정을 보이게 만듭니다.')
