...
// POUR 영업시스템과 '똑같은' 분류 체계 (POUR에 없는 '아스퀘'·'공사일정'은 제외 → 등록하면 POUR에 그대로 표시)
const APP_CAT_LABEL = { pt: 'PT', sales: '영업', bids: '현설', seminar: '세미나', personal: '개인', meeting: '회의', vacation: '휴가' }
