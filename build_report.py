...
hardcover_cards = [
    card("표지", "뒤 · 책등 · 앞 (외지)",
         [("구성", "앞표지 + 책등 + 뒤표지 (220 + 15 + 220mm)"),
          ("앞표지 카피", "공동주택 유지보수의 전문감리기관"),
          ("제본", "하드커버 양장")],
         [{"path": "하드커버_A.png", "label": "표지 스프레드 — 뒤 · 책등 · 앞", "mock": True}]),
    card("내부", "좌 · 우 (내지)",
         [("좌면", "로고 · 연락처 (square1600@naver.com / 1600-6069)"),
          ("우면", "로고 강조 · 슬로건 · 4아이콘"),
          ("슬로건", "신뢰받는 파트너, 완성도 높은 결과")],
         [{"path": "하드커버_B.png", "label": "내부 스프레드 — 좌 · 우", "mock": True}]),
]
