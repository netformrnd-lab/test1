...
# ----- 9. 겨울 유니폼 -----
uniform_cards = [
    card("①", "아트윈 A-41 프라다 점퍼 (추동겸용 · 내피 탈부착, 네이비)",
         [("품번", "A-41 (브랜드 아트윈)"),
          ("종류", "추동겸용 점퍼 · 내피 탈부착"),
          ("색상", "네이비"),
          ("소재 / 사이즈", "확인 예정"),
         ...
         url="https://dyuniform.com/product/%EC%95%84%ED%8A%B8%EC%9C%88-a-41-%ED%94%84%EB%9D%BC%EB%8B%A4%EC%A0%90%ED%8D%BC%EC%B6%94%EB%8F%99%EA%B2%B8%EC%9A%A9%EB%82%B4%ED%94%BC%ED%83%88%EB%B6%80%EC%B0%A9/5229/category/179/display/1/",
...
idcard_cards = [
    ...
    card("🪪", "실물 목업 — 박도윤 (현장관리 매니저)",
         [("성명", "박도윤 · 현장관리 매니저"),
          ("사번", "EMPLOYEE ID  AS-24028"),
          ("스타일", "네이비 홀더 · 도면 그리드 배경")],
         [{"path": "사원증_목업1.png", "label": "실물 목업 · 클릭 시 크게 보기", "mock": True, "hifi": True}]),
    card("🪪", "실물 목업 — 김하늘 (프로젝트 매니저)",
         [("성명", "김하늘 · 프로젝트 매니저"),
          ("사번", "EMPLOYEE ID  AS-24017"),
          ("스타일", "투명 홀더 · 블루 웨이브")],
