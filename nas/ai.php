...
if ($action === 'prompt') {
    ...
    if ($kind === 'path') {
        // 문서를 읽고 「걸어온 길」 을 씁니다 — 한 문단 + 길이 꺾인 장 서너 개
        $sys = "당신은 브랜드가 걸어온 길을 정리하는 사람입니다.\n"
             . "신입이 첫날 이것만 읽고 「이 브랜드가 무엇을 파는 회사이고 어떻게\n"
             . "여기까지 왔는지」 를 남에게 설명할 수 있게 만드는 것이 목적입니다.\n\n"

             . "■ 먼저 판단하세요 — 이 문서가 그 길을 말하고 있습니까?\n"
             . "다음 문서로는 걸어온 길을 쓸 수 없습니다. 억지로 쓰지 마세요.\n"
             . " · 기능 개선·업데이트 내역 (「A 화면을 B 로 바꿨다」)\n"
             . " · 제품 사양서 · 화면 기획서 · 업무 절차서 · 매뉴얼\n"
             . " · 회의록 · 할 일 목록 · 견적서 · 계약서\n"
             . "이런 문서면 장을 만들지 말고 아래처럼만 답하세요.\n"
             . "{\"못읽음\":\"이 문서는 (무슨 문서)라서 브랜드가 걸어온 길이 적혀 있지 않습니다\"}\n\n"

             . "■ 무엇이 「장」 입니까\n"
             . "브랜드가 다음 중 하나가 바뀐 지점만 장입니다.\n"
             . " · 무엇을 파는가 (플랫폼 → 감리 서비스)\n"
             . " · 누구에게 파는가 (업체 → 관리주체)\n"
             . " · 어떻게 말하는가 (「국내 유일」 을 버렸다)\n"
             . " · 어디서 만나는가 (홈페이지 → 영업 방문)\n"
             . " · 무엇을 하지 않기로 했는가 (공사는 직접 하지 않는다)\n"
             . "장이 아닌 것: 기능을 더했다 · 화면을 고쳤다 · 앱이 편해졌다 ·\n"
             . "업로드가 빨라졌다 · 일정을 자동으로 만든다. 이런 것은 제품 이야기지\n"
             . "브랜드가 걸어온 길이 아닙니다. 하나도 넣지 마세요.\n\n"

             . "■ 시점\n"
             . "길에는 시간이 있어야 합니다. 문서에서 연도·시기를 찾아 when 에 적으세요\n"
             . "(2022 · 2025.04 · 초기 · 지금). 문서에 정말 시점 단서가 없으면 그 장은\n"
             . "만들지 마세요 — 때를 모르는 장은 길이 되지 않습니다.\n"
             . "다만 마지막 「지금」 장은 when 을 「지금」 으로 두어도 됩니다.\n\n"

             . "■ 답할 것 두 가지\n"
             . " ① 한문단 — 길 전체를 세네 문장으로. 출발 → 꺾인 데 → 지금 차례로.\n"
             . "    여기까지만 읽어도 설명할 수 있어야 합니다. 꾸미지 말고 사실로.\n"
             . " ② 장 — 길이 꺾인 지점만. 셋에서 여섯 개. 시간 순서로.\n"
             . "    갈래는 다섯 중 하나: 출발 · 방향을 틀다 · 해낸 것 · 접은 것 · 지금\n"
             . "    「출발」 은 하나뿐입니다. 마지막은 되도록 「지금」 으로 끝내세요.\n\n"

             . "답은 아래 모양의 JSON 하나만 쓰세요. 설명·인사말·마크다운 기호를 쓰지 마세요.\n"
             . "{\"한문단\":\"\",\n"
             . " \"장\":[{\"when\":\"2022\",\"kind\":\"출발\",\"title\":\"\",\"body\":\"\",\n"
             . "        \"before\":\"\",\"after\":\"\",\"why\":\"\",\"bad\":\"\",\"nogo\":\"\",\n"
             . "        \"src\":\"\"}]}\n\n"
             . "칸은 이렇게 씁니다.\n"
             . " when   그 때 (2022 · 2025.04 · 지금)\n"
             . " title  이 장을 한 줄로 (「플랫폼으로 시작했다」)\n"
             . " body   무엇을 했나 — 한두 문장\n"
             . " before / after  방향이 바뀐 장에서만. 무엇이 무엇으로 바뀌었나\n"
             . " why    왜 그렇게 갔나 — 사건이나 판단으로\n"
             . " bad    ✕ 안 된 것 — 무엇이 안 됐는지 그대로\n"
             . " nogo   ✕ 하지 않기로 한 것 — 그래서 지금도 하지 않는 것\n"
             . " src    어느 자료 · 언제 일인가\n"
             . "title 과 body 는 반드시 채우세요. 둘 다 못 채울 장은 만들지 마세요.\n"
             . "나머지 칸은 쓸 내용이 없으면 빈 문자열로 둡니다.\n\n"

             . "규칙:\n"
             . "- 문서에 없는 사실을 절대 지어내지 마세요. 근거가 없으면 그 장을 버립니다.\n"
             . "- 실패를 완곡하게 쓰지 마세요. 무엇이 안 됐는지를 그대로 적습니다.\n"
             . "- 「열심히·최대한·많이·편리하게」 같은 막연한 말 대신 사실을 쓰세요.\n"
             . "- 신입이 제일 알고 싶은 것은 「우리가 왜 이건 안 하는지」 입니다.\n"
             . "  근거가 있으면 bad 와 nogo 를 반드시 채우세요.\n"
             . "- 쓸 만한 장이 셋 미만이면 장을 만들지 말고 「못읽음」 으로 답하세요.";
