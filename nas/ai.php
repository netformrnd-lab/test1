...
if ($action === 'prompt') {
    ...
    if ($kind === 'path') {
        ...
        $secB = "■ 네 가지를 씁니다\n"
             ...
             . " 첫2주 — 신입이 첫 2주에 직접 해볼 차례와, 첫 달에 해냈으면 하는 것.\n"
             . "   읽고 끝나면 신입은 내일 아무것도 못 합니다. 손을 댈 것을 줍니다.\n"
             . "   6절 실행 계획의 단계를 신입이 혼자 해볼 수 있는 크기로 쪼개세요.\n"
             . "   며칠차(1일차 · 1주차 · 2주차) · title(해볼 것) · body(어떻게)\n"
             . "   · 누구(확인해 줄 사람 이름 — 위 「사람」 에 있는 이름 그대로)\n"
             . "   첫달목표 는 한 줄입니다. 한 달 뒤에 무엇을 해냈으면 되는지를\n"
             . "   눈에 보이는 결과로 적으세요 (「글 2편을 혼자 써서 올린다」).\n"
             . "   「열심히 배운다 · 분위기에 적응한다」 같은 것은 목표가 아닙니다.\n"
             . "   문서에 실행 계획이 없으면 차례를 빈 목록으로 두세요.\n"
             . "\n";

        $shapeB = "{\"무엇\":\"\",\n"
             . " \"사람\":[{\"name\":\"\",\"role\":\"\",\"where\":\"\"}],\n"
             . " \"첫2주\":{\"첫달목표\":\"\",\n"
             . "         \"차례\":[{\"며칠차\":\"1일차\",\"title\":\"\",\"body\":\"\",\"누구\":\"\"}]}}\n\n";
        ...
        $brief = $long
            ? "■ 문서가 깁니다 — 짧게 쓰세요\n"
              ...
              . "여정은 많아야 6칸 · 지킬것은 많아야 8줄 · 해볼 차례는 많아야 6칸.\n\n"
            : '';
        ...
        if ($part === 3) {
            ...
            // 지침서에는 실행 계획이 없으므로 「첫2주」 를 억지로 만들지 않습니다
            $secB = ($doc === 'guide')
                ? $secB . " ※ 이 문서는 지침서입니다. 실행 계획이 없으면 차례를 빈 목록으로,\n"
                        . "   첫달목표를 빈 문자열로 두세요. 지어내지 마세요.\n\n"
                : $secB;
