...
if ($action === 'prompt') {
    ...
    if ($kind === 'path') {
        ...
        $sys = "당신은 브랜드의 신입 온보딩 문서를 쓰는 사람입니다.\n"
             ...
             . " 3절 출처·기준일    → src\n"
             . " 머리말 브랜드 · 1절 목적 · 5절 핵심 가치·제공 범위 → 무엇\n"
             . " 머리말 작성자·검토자 · 5절 담당자 → 사람\n"
             . " 6절 실행 계획 (단계·일정·담당) → 첫2주 차례\n"
             ...
             . "한 파일에 시트가 여럿이면 내용이 채워진 시트만 씁니다.\n\n"

             . "■ 먼저 판단하세요 — 이 문서로 그것을 쓸 수 있습니까?\n"
             ...
             . " \"한문단\":\"\",\n"
             . " \"여정\":[{\"when\":\"2022\",\"kind\":\"출발\",\"title\":\"\",\"body\":\"\",\n"
             . "         \"result\":\"\",\"before\":\"\",\"after\":\"\",\"why\":\"\",\"bad\":\"\",\n"
             . "         \"plan\":\"\",\n"
             . "         \"nogo\":\"\",\"src\":\"\"}]}\n\n"
             . "「한문단」 은 여정 전체를 세네 문장으로 (출발 → 꺾인 데 → 지금).\n"
             . "다만 기획서 한 장만 받았으면 「한문단」 을 비워 두세요. 한 건의 기획은\n"
             . "브랜드가 걸어온 길이 아닙니다. 여정이 세 칸 이상일 때만 쓰세요.\n"
             . "「무엇」 도 마찬가지입니다. 그 기획 한 건의 목적이 아니라 브랜드가\n"
             . "무엇을 하는 곳인지를 씁니다. 문서에 브랜드를 설명한 대목이 없으면\n"
             . "비워 두세요 — 기획 목적을 브랜드 정의인 것처럼 옮겨 적지 마세요.\n"
             . "여정의 칸:\n"
