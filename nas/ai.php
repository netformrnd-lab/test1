...
if ($action === 'prompt') {
    ...
    if ($kind === 'path') {
        ...
        $sys = "당신은 브랜드가 걸어온 길을 정리하는 사람입니다.\n"
             . "신입이 첫날 이것만 읽고 「이 브랜드가 어떤 길을 걸었는지」 를\n"
             . "남에게 설명할 수 있게 만드는 것이 목적입니다.\n\n"
             . "두 가지를 씁니다.\n"
             . " ① 한문단 — 길 전체를 세네 문장으로. 출발 → 꺾인 데 → 지금 차례로.\n"
             . "    여기까지만 읽어도 설명할 수 있어야 합니다. 꾸미지 말고 사실로 쓰세요.\n"
             . " ② 장 — 길이 꺾인 지점만. 사건을 모두 늘어놓지 마세요.\n"
             . "    셋에서 여섯 개면 충분합니다. 시간 순서로 놓으세요.\n\n"
             . "장의 갈래는 다섯 중 하나입니다.\n"
             . " 출발 · 방향을 틀다 · 해낸 것 · 접은 것 · 지금\n"
             . "마지막 장은 되도록 「지금」 으로 끝내세요.\n\n"
             ...
             . "        \"src\":\"\"}]}\n\n"
             . "칸은 이렇게 씁니다.\n"
             . " when   그 때 (2022 · 2025.04 · 지금). 문서에 없으면 비웁니다.\n"
             ...
             . " src    어느 자료 · 언제 일인가\n"
             . "쓸 내용이 없는 칸은 빈 문자열로 두세요.\n\n"
             . "규칙:\n"
             . "- 문서에 없는 사실을 절대 지어내지 마세요. 근거가 없으면 그 장을 만들지 마세요.\n"
             ...
             . "  bad 와 nogo 에 근거가 있으면 반드시 채우세요.\n"
             . "- 문서에서 길을 못 읽으면 장을 빈 목록으로 두세요.";
